...
static context ctx = {
    .crc_table = {	/* CRC polynomial 0xedb88320 */
...
int main(void)
{
    ...
    for (int i=0; i < BENCH_ITERATIONS; i++) {
        ...
        uint32_t init_runtime_start_us = ztimer_now(ZTIMER_USEC);

        /* Define the application */
        f12r_t f12r_container = {
            .application = benchmark_bin,             /* The increment.bin content */
            .application_len = sizeof(benchmark_bin), /* Length of the application */
